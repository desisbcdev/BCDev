...
page 50010 "Goods Receipt Subform"
{
    AutoSplitKey = true;
    Caption = 'Lines';
    DelayedInsert = true;
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Direct Unit Cost Excl GST"; Rec."Direct Unit Cost")
                {
                    ApplicationArea = all;
    ...
    procedure ShowDeferralScheduleCust()
    var
        PurchaseHeader: Record "Purchase Header";
    begin
        PurchaseHeader.Get(Rec."Document Type", Rec."Document No.");
        Rec.ShowDeferrals(PurchaseHeader."Posting Date", PurchaseHeader."Currency Code");
    end;
}
