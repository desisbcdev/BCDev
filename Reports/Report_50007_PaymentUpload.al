report 50007 "Payment Upload"
{
    Caption = 'Payment Upload';
    ...
    begin
        ...
        CompBankAcct.Get("Gen. Journal Line"."Bal. Account No.");
        ...
        if "Gen. Journal Line"."Account Type" = "Gen. Journal Line"."Account Type"::Vendor then begin
            ...
            if "Gen. Journal Line"."Account Type" = "Gen. Journal Line"."Account Type"::Employee then begin
                ProductCode := 'SALPAY';
                EmployeeRec.Get("Gen. Journal Line"."Account No.");
        ...
        if Today < "Gen. Journal Line"."Posting Date" then
            ExportDateVar := "Gen. Journal Line"."Posting Date"
        else
            ExportDateVar := Today;
        ...
        AmountVar := Round(abs("Gen. Journal Line".Amount), 0.01);
        BankCodeIndicator := 'M';
        ...
        Case "Gen. Journal Line"."Account Type" of
            "Gen. Journal Account Type"::Vendor:
                begin
                    ...
                    VendorLedgEntry.setrange("Vendor No.", "Gen. Journal Line"."Account No.");
                    IF "Gen. Journal Line"."Applies-to ID" = '' THEN
                        VendorLedgEntry.SETRANGE("Applies-to ID", "Gen. Journal Line"."Document No.")
                    ELSE
                        VendorLedgEntry.SETRANGE("Applies-to ID", "Gen. Journal Line"."Applies-to ID");

                    IF VendorLedgEntry.FINDSET THEN BEGIN
                        REPEAT
                            LoopCnt += 1;
                            EnrichmentArr[LoopCnt] := VendorLedgEntry."Document No.";

                        until (VendorLedgEntry.Next = 0) or (LoopCnt = 23);
                    end;
    ...
    BEGIN
        ...
        FOR Position := 1 TO StrLenVal DO
            RepCheckCu.CheckIsNumeric(TextVal, Position, "Gen. Journal Line"."Line No.", FieldName);
    ...
    BEGIN
        ...
        FOR Position := 1 TO StrLenVal DO
            RepCheckCu.CheckIsAlphabet(TextVal, Position, "Gen. Journal Line"."Line No.", FieldName);
    END;
    ...
    BEGIN
        ...
        FOR Position := 1 TO StrLenVal DO
            RepCheckCu.CheckIsAlphaNumeric(TextVal, Position, "Gen. Journal Line"."Line No.", FieldName);
    ...
    var
        ...
        ReportFileName: Label 'PaymentUpload';
