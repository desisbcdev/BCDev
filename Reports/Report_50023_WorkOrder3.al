report 50023 WorkOrder3
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    DefaultLayout = RDLC;
    RDLCLayout = './WorkOrder3.rdl';
    Caption = 'Work Order3';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            { }
            column(chargesValue; chargesValue)
            { }
            column(ChargesMovementCap; ChargesMovementCap)
            { }
            column(chargesMovementCap1; chargesMovementCap1)
            { }
            ...
            begin
                ...
                if "Currency Code" = '' then
                    chargesValue := StrSubstNo(ChargesCap, 'INR')
                else
                    chargesValue := StrSubstNo(ChargesCap, "Currency Code");
                if "Currency Code" = '' then
    ...
    var
        ...
        TotalPriceCap: Label 'Total Amount %1';
        ...
        RefValue: Text;
        ChargesMovementCap: Label 'Charges For Movement within Pheonix Building:';
        chargesMovementCap1: Label 'Charges For Movement from Pheonix-IVYL1 floor:';
        SlNoCap: Label 'Sl.No';
