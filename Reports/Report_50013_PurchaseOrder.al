report 50013 PurchaseOrder
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(SpeQtyCap; SpeQtyCap)
            {

            }
            column(SpeDescriptionCap; SpeDescriptionCap)
            {

            }
            column(SerialNoProductCodeCap; SerialNoProductCodeCap)
            {

            }
            Column(AnnexureCaption; StrSubstno(AnnexureCaption, "Purchase Header"."No."))
            {
            ...
            dataitem("Payment Terms And Conditions"; "Payment Terms And Conditions")
            {
                ...
                column(PaymentTermsLineLineNo; "Payment Terms And Conditions".LineNo)
                {
            ...
            dataitem(Specification; Specification)
            {
                ...
                column(Specification_Description; Specification.Description)
                {

                }
                column(Specification_Qty; Specification.Qty)
                {

                }

                Column(Specification_Document_No_; Specification."Document No.")
                {

                }
                column(Specification_Line_No_; Specification."Line No.")
                {

                }
                column(Specification_UOM; Specification.UOM)
                {
                    IncludeCaption = true;
                ...
                column(Specification_Amount; Specification.Amount)
                {
                    IncludeCaption = true;
                ...
                column(Specification_Unit_Cost; Specification."Unit Cost")
    ...
    var
        ...
        SerialNoProductCodeCap: Label 'Serial No./Product Code';
        SpeDescriptionCap: Label 'Description';
        SpeQtyCap: Label 'Qty';
        ...
        AnnexureCaption: Label 'Annexure for Po : %1';
