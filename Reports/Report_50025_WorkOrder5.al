report 50025 WorkOrder5
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    DefaultLayout = RDLC;
    RDLCLayout = './WorkOrder5.rdl';
    Caption = 'Work Order5';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            { }
            column(LineDiscountamountGvar; LineDiscountamountGvar)
            { }
            ...
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                begin
                    ...
                    LineDiscountamountGvar += "Line Discount Amount";
    ...
    var
        ...
        LineDiscountamountGvar: Decimal;
